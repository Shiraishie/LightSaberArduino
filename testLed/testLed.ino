...
void loop() {
  ...
  IgnitionNew1(strip.Color(255, 0, 0), 0.000002,strip.Color(255,255,255),0,50); // Red
  
  //breathe(255,10,5,1);//Fade stuff #Maximum bightness is 255-50 so it adds up to 255
  retraction(0.00001);
